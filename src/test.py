...
def processNotification(query):
    systemPrompt = """Ты - умный помощник-трекер учебных задач. Твоя задача - по текстовому описанию задания составить текст персонального уведомления для напоминания человеку о том, что это задание необходимо выполнить. Составь JSON-объект в соответствии со следующим форматом {"text": "текст уведомления для напоминания"}."""
